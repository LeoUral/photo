...
export default class Main extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            urlComent: '' // URL коментария для просомтра
        }
    ...
    defineNumberImage() {
        ...
        // console.log(`this.state.foto:::: `, this.state.foto); // test
    }
    ...
    render() {
        ...
        return (
            <>
                <main className="main" >
                    <ModalWindow numberGallary={this.state.gallary[0]}
                        numberImage={this.state.numberFoto}
                        show={this.state.show}
                        onChangeShow={this.changeShow}
                        onStepLeft={this.doStepLeft}
                        onStepRight={this.doStepRight} />
                    <ModalComments onChangeVisual={this.doChangeVisual}
                        visual={this.state.visual}
                        urlComment={this.state.urlComment}
                    />
                    <section className="main__left" >
                        <div className="left_block" >
                            <div className="main__left_one one_width" >
                                <button className="block_icon"
                                    onClick={this.handleOneButton}>
                                    <span> &#9675; </span>
                                </button>
                            </div>
                            ...
                            <div className="main__left_two one_width" >
                                <div className="text_block" >
                                    <h3> {i === 0 ? this.title0 : i === 1 ? this.title1 : this.title2} </h3> <p> {i === 0 ? this.text0 : i === 1 ? this.text1 : this.text2} </p>
                                </div > <div className="links-block" >
                                    <button className="link active-link"
                            ...
                            <div className="main__left_three one_width" > {i === 0 ? this.viewerBlockOne : i === 1 ? '' : ''}
                            </div>
                        </div>
